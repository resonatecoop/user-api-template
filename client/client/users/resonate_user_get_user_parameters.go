...
// NewResonateUserGetUserParams creates a new ResonateUserGetUserParams object,
...
func NewResonateUserGetUserParams() *ResonateUserGetUserParams {
	return &ResonateUserGetUserParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewResonateUserGetUserParamsWithTimeout creates a new ResonateUserGetUserParams object
...
// NewResonateUserGetUserParamsWithContext creates a new ResonateUserGetUserParams object
...
// NewResonateUserGetUserParamsWithHTTPClient creates a new ResonateUserGetUserParams object
...
func (o *ResonateUserGetUserParams) WithDefaults() *ResonateUserGetUserParams {
	o.SetDefaults()
	return o
}
...
func (o *ResonateUserGetUserParams) WithTimeout(timeout time.Duration) *ResonateUserGetUserParams {
...
func (o *ResonateUserGetUserParams) WithContext(ctx context.Context) *ResonateUserGetUserParams {
	o.SetContext(ctx)
	return o
}
...
func (o *ResonateUserGetUserParams) WithID(id string) *ResonateUserGetUserParams {
	o.SetID(id)
	return o
}
...
func (o *ResonateUserGetUserParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
